...
__model_path__ = os.path.join(__tmp_dir__, 'data_functional_testing', 'spinegeneric_model.pt')
...
def test_convert_to_onnx():
    ...
    assert os.path.exists(os.path.join(__tmp_dir__, 'data_functional_testing',
                                       'spinegeneric_model.onnx'))
