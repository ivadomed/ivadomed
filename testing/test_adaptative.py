...
from ivadomed.loader import utils as imed_loader_utils, adaptative as imed_adaptative, loader as imed_loader
...
def test_hdf5():
    ...
    dataset = imed_loader.BidsDataset(root_dir=PATH_BIDS,
