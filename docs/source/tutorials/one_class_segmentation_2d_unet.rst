...
====================================
    ...
    An interactive Colab version of this tutorial is directly accessible `here <https://colab.research.google.com/github/ivadomed/ivadomed/blob/yd/incorporating_colab_tutorials/testing/tutorials/tutorial_1_2d_segmentation_unet.ipynb>`_.
