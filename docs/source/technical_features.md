...
- [Generalised Dice Loss](https://arxiv.org/abs/1707.03237): The background volume is weighted by the inverse of its area. This loss is particularly interesting with class imbalance.
