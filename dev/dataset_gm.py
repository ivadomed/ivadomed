    ...
    if len(niis) < 4:
        ...
        if folder_name in subfolders2:
            for nii in niis:
                ...
                shutil.copyfile(os.path.join(path,subfolder,"t2s",nii),os.path.join(path2,"derivatives/labels",folder_name,"anat", folder_name + "_T2star" + "_seg-lesion" + centers[nii_center] + ".nii.gz"))
